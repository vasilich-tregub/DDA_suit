...
int ix0, iy0, ix1, iy1;
inode nextnode{ WIDTH, HEIGHT, LEFT };
vec linevec{};
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_LBUTTONUP:
        ...
        {
            x0 = xPosDown / 16.0; yy0 = 32.0 - yPosDown / 16.0; x1 = xPosUp / 16.0; yy1 = 32.0 - yPosUp / 16.0;
        }
        else
        {
            x0 = xPosDown / 16; yy0 = 32 - yPosDown / 16; x1 = xPosUp / 16; yy1 = 32 - yPosUp / 16;
        }
        for (int ix = 0; ix < WIDTH * HEIGHT; ++ix) fld[ix] = pxlnan;
